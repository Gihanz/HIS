...
public class MriTestFields {
	...
	public String GetAllLabTestTypes() {
		...
		//	return serializer.exclude("*.class","mriLaboratory.*").serialize(deptList);
			return serializer.include("mriLaboratory.laboratoryName","mriSpecimenType.specimenName").exclude("*.class").serialize(deptList);
		} catch(Exception e) {
			return e.getMessage();
		}		
	}
	...
	public String addLabTestName(JSONObject obj)
	{
		...
		try {
			...
			test.setDefultTestComment(obj.getString("defult_test_comment"));
			test.setTestUnit(obj.getString("test_unit"));
			Session session = SessionFactoryUtil.getSessionFactory().openSession();
			MriLaboratory lab = (MriLaboratory) session.load(MriLaboratory.class, obj.getInt("lab"));
			test.setMriLaboratory(lab);
			MriSpecimenType specTypes = (MriSpecimenType) session.load(MriSpecimenType.class, obj.getInt("specimen_type"));
			test.setMriSpecimenType(specTypes);
			session.close();
