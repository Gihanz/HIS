<div class="col-md-12">
    ...
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">DB Management</h3>
        </div><!-- /.box-header -->
...
<form class="form-horizontal" role="form" method="POST" id="form_dba">
                <div class="panel panel-default">
...
$(document).on('click', '.panel-heading span.clickable', function (e) {
   ...
   //  <!--Model for insert new employee-->
                ...
                json.push(obj)
                var newDbaJSONObject = {"NewDba": json};
                //alert(JSON.stringify(newEmployeeJSONObject));

                $.ajax({
                    type: "POST",
                    url: 'dba_controller/InsertNewDba',
                    data: {'dba': newDbaJSONObject}, success: function (output) {
                        alert("Successfully Inserted!"+output);
                        document.getElementById("form_dba").reset();
                    }
                });
       ...
       // <!--View for register employee-->
          $('#btn_reg_employee').click(function () {
               ...
               // alert(JSON.stringify(newUserJSONObject));
                ...
                $.ajax({
                    type: "POST",
                    url: 'dba_controller/registerDba',
