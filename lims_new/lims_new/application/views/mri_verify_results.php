                ...
                <div class="row col-sm-12 form-horizontal"  >                                    
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                                                            ...
                                                            <textarea id="test_request_comment_edit" name="test_request_comment_edit" class="form-control" rows="2" readonly=""></textarea>  
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                                                            ...
                                                            <textarea id="test_request_new_comment_edit" name="test_request_comment_edit" class="form-control" rows="2"></textarea> 
        ...
        var checkVal= '3';
         ...
         if($("#check_"+testrequest_id+"").is(':checked')){
          ...
          //test request comment 
           var comment= $("#test_request_new_comment_hdn_"+testrequest_id+"").val();
           var userid =$("#feildUserId").val();
            var userName =$("#feildUserName").val();
             var userRole =$("#feildUserRole").val();
//Removed Bug need to remove kanchana  24 06 16
             // if(checkVal=='3' && comment==''){
                //alert("Please enter a Comment for Test cannot be verified ! ");
               //  $("#saveError").val("Please enter a Comment for Test cannot be verified !");
               // success=false;
 ...
 //}
    ...
    function displayResults(obj) {
        ...
        $.each(obj, function(x, val) {
            ...
            str += '<td><div class="checkbox"><label><input data-testrequestid="'+val.test_request_id+'"   id="check_'+resultid+'" type="checkbox" data-result_id="'+resultid+'"  value="" data-save="save"></label></div></td>';
...
$(document).on('click','.btn_edit',function(){
    ...
    $('#patient_name_edit').val($(this).closest("tr").find('td:eq(1)').text());
      ...
      $('#test_request_comment_edit').val($('#test_request_comment_hdn_'+test_request_id).val()); 
       ...
       $('#test_request_new_comment_edit').val($('#test_request_new_comment_hdn_'+test_request_id).val());
});
