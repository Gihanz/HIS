...
class Patient_Model extends CI_Model {
    ...
    public function GetAllPatientsSearch() {
        $headers = array();
        $this->load->model('/Service_Caller/ServiceCaller', 'serviceCaller');
        $serviceURL = SERVICE_BASE_URL . "MriPatient/GetAllPatientsSearch";
    //    $headers[] = 'abc:123222';
        $media_Type = "application/json";
        $response = $this->serviceCaller->curl_GET_All_Request($serviceURL, $media_Type);
    ...
    public function GetAllInternalPatients() {
   ...
   public function GetPatientById($data) {
        ...
        $this->load->model('/Service_Caller/ServiceCaller', 'serviceCaller');
        $serviceURL = SERVICE_BASE_URL . "MriPatient/GetPatientById/$data";
    ...
    public function InsertNewPatient($patient) {
       ...
       public function UpdatePatient($patient) {
        ...
        $serviceURL = SERVICE_BASE_URL . "MriPatient/UpdatePatient";
        $media_Type = "application/json";
        //$curRequest= new ServiceCaller();
        $response = $this->serviceCaller->curl_POST_Request($serviceURL, $NewPatient, $media_Type);
        return $response;
      ...
      public function UpdateHospitalPatientVist($patient) {
        $this->load->model('/Service_Caller/ServiceCaller', 'serviceCaller');
        $NewPatient = $patient;
        //print_r($ExternalRequests);

        $serviceURL = SERVICE_BASE_URL . "MriHospitalPatient/UpdatePatient";
        $media_Type = "application/json";
        //$curRequest= new ServiceCaller();
        $response = $this->serviceCaller->curl_POST_Request($serviceURL, $NewPatient, $media_Type);
        return $response;
        ...
        public function UpdateInternalPatientVist($patient) {
        $this->load->model('/Service_Caller/ServiceCaller', 'serviceCaller');
        $NewPatient = $patient;
        //print_r($ExternalRequests);

        $serviceURL = SERVICE_BASE_URL . "MriExternalPatient/UpdatePatient";
        $media_Type = "application/json";
        //$curRequest= new ServiceCaller();
        $response = $this->serviceCaller->curl_POST_Request($serviceURL, $NewPatient, $media_Type);
        return $response;
