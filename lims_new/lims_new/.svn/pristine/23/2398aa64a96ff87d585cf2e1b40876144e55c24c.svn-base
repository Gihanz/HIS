...
class Dba_Model_1 extends CI_Model {
...
/*    
    ...
    */
     ...
     public function makeArchieveScript($script) {
        $this->load->model('/Service_Caller/ServiceCaller', 'serviceCaller');
        $NewScript = $script;
      

        $serviceURL = SERVICE_BASE_URL . "DBAUser/makeArchieveScript";
        $media_Type = "application/json";
       
        $response = $this->serviceCaller->curl_POST_Request($serviceURL, $NewScript, $media_Type);
        return $response;
    }
