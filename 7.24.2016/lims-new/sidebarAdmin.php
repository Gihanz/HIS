        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="<?php echo base_url(); ?>patient_controller_1">
                    <i class="fa fa-users"></i> <span>Patient Registration</span>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url(); ?>new_test_request_controller">
                    <i class="fa fa-plus"></i> <span>Place New Test</span>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url(); ?>test_request_progress_controller">
                    <i class="fa fa-sort-amount-asc"></i> <span>Current Tests</span>
                </a>
            </li>
            <li class="active" >
                <a href="#">
           ...
           <!-- <li>
                <a href="<?php echo base_url(); ?>mri_result_verify">
                    <i class="fa fa-sort-amount-asc"></i> <span>Verify Results</span>
                </a>
            </li> -->
            
            <li class="active" >
                <a href="#">
                      <i class="fa fa-edit"></i> <span>Viorology</span>
                      <i class="fa fa-angle-left pull-right"></i>
                </a>                
                <ul class="treeview-menu">
                    <li><a href="<?php echo base_url(); ?>mri_binary_results">Enter Results </a></li>
                    <li><a href="<?php echo base_url(); ?>mri_binary_results/report"> Print Reports </a></li>
                  
                </ul>
            </li>
             <li>
                <a href="<?php echo base_url(); ?>mri_verify_results">
                    <i class="fa fa-sort-amount-asc"></i> <span>Verify Results</span>
                </a>
            </li>
            <li class="active" >
                ...
                <ul class="treeview-menu">
                    <li><a href="<?php echo base_url(); ?>employee_controller">User Management</a></li>
                    <li><a href="<?php echo base_url(); ?>department_controller">Department Management</a></li>
                    <li><a href="<?php echo base_url(); ?>userRoles_controller"><span>Role Management</span></a></li>
                    <li><a href="<?php echo base_url(); ?>dba_controller"><span>DB Management</span></a></li>
                    <li><a href="<?php echo base_url(); ?>mri_test_fields"> <i class="fa fa-circle-o"></i>Laboratory Test Management</a></li>
					<li><a href="<?php echo base_url(); ?>mri_specimen_type"><i class="fa fa-circle-o"></i>Add SpecimenType</a></li>
					<li><a href="<?php echo base_url(); ?>hospital_controller"><i class="fa fa-circle-o"></i>Hospitals</a></li>
